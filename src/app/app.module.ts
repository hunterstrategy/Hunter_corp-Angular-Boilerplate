...
import { BoilerplateNavbarComponent } from './boilerplate-navbar/boilerplate-navbar.component';
...
@NgModule({
  declarations: [
    AppComponent,
    BoilerplateAddressFormComponent,
    BoilerplateDashboardComponent,
    BoilerplateNavbarComponent,
    BoilerplateTableComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
